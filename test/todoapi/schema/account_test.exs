defmodule Todoapi.Schema.AccountTest do
  use Todoapi.Support.SchemaCase
  ...
  describe "changeset/2" do
    ...
    test "error: returns error changeset when an email address is reused" do
      Ecto.Adapters.SQL.Sandbox.checkout(Todoapi.Repo)
      ...
      assert {:error, %Changeset{valid?: false, errors: errors}} =
               Todoapi.Repo.insert(changeset_with_repeated_email)
